...
static void configure_STEPPER_pin(){
  ...
  RCC->AHB1ENR |= RCC_AHB1ENR_GPIOAEN;   
	...
	// we will use pin 6,7,8,9 of port A
...
//ODR of A has total 32 bits,lowest 16 bits correspond to all 16 pins output state ie high or low state,rest 16 are reserved
...
int main(void){
	...
	//at first,ensure that motor is turned off
	turn_off_A1();
	turn_off_B1();
	turn_off_A2();
	turn_off_B2();
